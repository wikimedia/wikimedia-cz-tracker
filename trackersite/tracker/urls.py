...
urlpatterns = patterns(
    ...
    url(r'^ticket/(?P<ticket_id>\d+)/media/add/success/$', 'tracker.views.update_media_success', name='update_media_success'),
    url(r'^ticket/(?P<ticket_id>\d+)/media/add/error/$', 'tracker.views.update_media_error', name='update_media_error'),
    ...
    url(r'^my/preferences/$', 'tracker.views.preferences', name='preferences'),
    url(r'^my/deactivate/$', 'tracker.views.deactivate_account', name='deactivate_account'),
